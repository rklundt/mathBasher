...
| [2.5.2](phase-2/2.5.2-minor-visual-tweaks.md) | Minor visual tweaks — catch-all batch of small presentation polish (spacing, color, sizing, copy, alignment, animation-feel) provided by the project owner. Accumulated into one review-and-ship pass. Tweak list TBD. | Planned (awaiting tweak list) |
