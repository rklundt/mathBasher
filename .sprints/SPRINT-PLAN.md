...
| [2.2.1](phase-2/2.2.1-post-climb-cleanup.md) | Post-Climb cleanup, UX polish, WebP migration, and cross-game scoring true-up — 12 active stories: kid-UX hints, config lift, dead-code cleanup, pickRung test coverage, WebP migration, arcade modes → 12 questions, cross-game max-score calibration. | In Progress (started 2026-05-22) |
