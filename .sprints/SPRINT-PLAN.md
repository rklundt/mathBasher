...
| [2.5](phase-2/2.5-splash-and-graphic-intros.md) | Splash screen, graphic intros + hero selection — boot splash / title screen, per-game-mode intro beat, and a 4-option diverse hero picker (female/male × dark/light). Presentation sprint. | In Progress (started 2026-05-23) |
