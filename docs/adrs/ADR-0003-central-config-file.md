...
- **Con:** Some "structural" numbers (loop indices, fixed array sizes derived from invariants) live as code constants and we have to judge what's tunable vs structural. Working rule: tunable = "we'd reasonably ever want to change this without changing logic"; structural = "changing it requires changing logic too."
