...
| ✓ | Check |
|---|---|
|   | **Speed bump (Story I)**: aliens descend ~10% faster than v0.5.4 across all three tiers (Slow / Medium / Fast). Wrong-shot penalty acceleration is also 10% faster. The game should feel snappier — not frantic — at every tier. Numbers in `src/core/config.ts`: slow 44 px/s, medium 66 px/s, fast 99 px/s descent. |
